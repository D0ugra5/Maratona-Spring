...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ValidationExceptionDetails> handlerMethodArgumentNotValidException(MethodArgumentNotValidException mth){
        List<FieldError>  fieldErrors  = mth.getBindingResult().getFieldErrors();
        ...
        return new ResponseEntity<>(
                ValidationExceptionDetails.builder()
                        ...
                        .developMessage(mth.getClass().getName())
                        .fields(fields)
